...
const menus = [
  ...
  { id: "MENU_TASKS", name: "对账治理 Agent", module: "业务支撑", roles: ["平台管理员", "财务复核人", "DMS负责人", "SAP负责人", "审计员"], status: "启用" },
...
const buttons = [
  { id: "BTN_ANALYZE", name: "启动归因", page: "对账治理 Agent", action: "执行", risk: "中", roles: ["平台管理员", "财务复核人"] },
  { id: "BTN_CONFIRM", name: "确认归因", page: "对账治理 Agent", action: "复核", risk: "中", roles: ["财务复核人"] },
  { id: "BTN_REJECT", name: "退回复核", page: "对账治理 Agent", action: "复核", risk: "中", roles: ["财务复核人", "DMS负责人", "SAP负责人"] },
...
const agents = [
  { id: "A01", name: "对账治理智能归因 Agent", owner: "财务共享中心", status: "运行中" },
...
const auditLogs = [
  ...
  { time: "10:21:05", user: "对账治理Agent", action: "读取资源", target: "DMS收入台账", result: "允许/只读" },
  { time: "10:21:08", user: "财务复核人", action: "查看SAP原始凭证", target: "SAP过账凭证", result: "拒绝" },
  { time: "10:22:14", user: "平台管理员", action: "发布Agent", target: "对账治理Agent", result: "需审批" },
];
...
export function RbacView() {
  ...
  const [selectedAgent, setSelectedAgent] = useState("对账治理智能归因 Agent");
